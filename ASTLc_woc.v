...
Proof.
  ...
  - intros. specialize (IHclos_refl_trans_n1 (eq_refl _)).
    ...
    + destruct stk'.
      ...
      * inversion H2; subst.
        inversion H1; subst.
        pose proof IHclos_refl_trans_1n c None st2 p ((c, None, st2) :: stk') stk'' (eq_refl _) (in_eq _ _). exact H2.
      * inversion H1; subst.
        pose proof IHclos_refl_trans_1n c l st p ((c0, None, st2) :: stk') stk'' (eq_refl _) (in_cons _ _ _ H2). exact H3.
    + destruct stk'.
      inversion H2.
      destruct H2.
      * inversion H2; subst.
        inversion H1; subst.
        pose proof IHclos_refl_trans_1n c (Some l2) st2 p ((c, Some l2, st2) :: stk') stk'' (eq_refl _) (in_eq _ _). exact H2.
      * inversion H1; subst.
        pose proof IHclos_refl_trans_1n c l st p ((c0, Some l2, st2) :: stk') stk'' (eq_refl _) (in_cons _ _ _ H2). exact H4.
